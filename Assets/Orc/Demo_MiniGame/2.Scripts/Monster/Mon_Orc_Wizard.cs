...
public class Mon_Orc_Wizard : Mon_Bass
{
    ...
    public override void SkillAttack_Anim_2_Enter()
    {
        ...
        for (int i = 0; i < Demo_GM.Gm.MonsterList.Count; i++)
        {
            ...
            if (Demo_GM.Gm.MonsterList[i] == null)
                continue;

            Vector2 pos = new Vector2(Demo_GM.Gm.MonsterList[i].transform.position.x, Demo_GM.Gm.MonsterList[i].transform.position.y);

            Instantiate(HealPrefab, pos, Quaternion.identity);

            Demo_GM.Gm.MonsterList[i].GetComponent<Mon_Bass>().Damaged(-50,  new Vector2(0, 0), 0);
    ...
    IEnumerator HasteTimmer_Co()
    {
        ...
        for (int i = 0; i < Demo_GM.Gm.MonsterList.Count; i++)
        {
             Demo_GM.Gm.MonsterList[i].GetComponent<Mon_Bass>().SetAttackSpeed(2f);
             Demo_GM.Gm.MonsterList[i].GetComponent<Mon_Bass>().SetMoveSpeed(1);
        }
        ...
        for (int i = 0; i < Demo_GM.Gm.MonsterList.Count; i++)
        {
             Demo_GM.Gm.MonsterList[i].GetComponent<Mon_Bass>().SetAttackSpeed(1);
            Demo_GM.Gm.MonsterList[i].GetComponent<Mon_Bass>().SetMoveSpeed(1);
        }
